...
parameter byte_enable_mask_width = 2; 
...
begin
    ...
    mem_init ={((last_address - first_address + 1)*data_width){1'b0}};
...
module hardcopyiv_lcell_hsadder (
    ...
    assign sumout = sumout_tmp[dataa_width - 1 : 0];
    assign cout = sumout_tmp[dataa_width];
