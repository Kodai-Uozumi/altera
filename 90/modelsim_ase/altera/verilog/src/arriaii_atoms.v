...
// test bus loopback
assign test_bus  = {~dqsupdateen, offsetctrl_reg_mux, delayctrl_reg_mux}; 
...
begin
    // detect  falling edge of terminationuserclear
    if(terminationuserclear == 1'b0 && terminationuserclear_prev == 1'b1)
        begin
            reset_oct_reg = 1'b1;
    ...
    //  detect  rising edge of terminationuserclear
    if(terminationuserclear == 1'b1 && reset_oct_reg == 1'b1)
        begin
            reset_oct_reg = 1'b0;
