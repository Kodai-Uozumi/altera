...
#    NamedEvent, SpecParam, CellInternal and None.
# Default is: Memory Variable Generic Constant Parameter SpecParam ImmediateAssert Assertion Cover Endpoint
# Use "None" to turn off all filtering.
#
set WildcardFilter [list Variable Constant Generic Parameter SpecParam Memory CellInternal ImmediateAssert Assertion Cover Endpoint ]
...
#	set PrinterSetup(dffont) Helvetica
   ...
   set PrefSource(HighlightErrorColor) orange
	...
	if {[winfo depth .] > 1} {
		...
		set PrefCoverage(excludedHitsColor) green
